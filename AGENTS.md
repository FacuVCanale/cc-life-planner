...
Estas reglas aplican a todo trabajo de Codex en este repo. Leelas antes de cualquier acción.

## Nota Codex

Este archivo es la adaptación de `CLAUDE.md` para Codex. Si hay referencias a `.claude/skills` o slash commands, interpretalas como workflows/skills equivalentes migradas a Codex.
